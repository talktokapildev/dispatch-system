...
const envSchema = z.object({
  ...
  STRIPE_LIVE_SECRET_KEY: z.string().optional().default("placeholder"),
  STRIPE_LIVE_PUBLIC_KEY: z.string().optional().default("placeholder"),
  STRIPE_TEST_SECRET_KEY: z.string().optional().default("placeholder"),
  STRIPE_TEST_PUBLIC_KEY: z.string().optional().default("placeholder"),
  STRIPE_TEST_PHONES: z.string().optional().default(""),
  STRIPE_WEBHOOK_SECRET: z.string().optional(),
