  ...
  fastify.get("/driver-applications/:id", async (request, reply) => {
    ...
    const application = await fastify.prisma.driverApplication.findUnique({
      ...
      select: {
        ...
        vehicleClass: true,
        vehicleSeats: true,
        vehiclePhvLicenceNumber: true,
        vehiclePhvLicenceExpiry: true,
        vehiclePhvDiscNumber: true,
        vehicleEmissionStandard: true,
        vehicleIsUlezCompliant: true,
        createdAt: true,
        updatedAt: true,
        docPcoBadge: true,
        docDrivingLicFront: true,
    ...
    return reply.status(200).send({
      ...
      vehicleClass: application.vehicleClass ?? "STANDARD",
      vehicleSeats: application.vehicleSeats ?? 4,
      vehiclePhvLicenceNumber: application.vehiclePhvLicenceNumber ?? "",
      vehiclePhvLicenceExpiry: application.vehiclePhvLicenceExpiry ?? null,
      vehiclePhvDiscNumber: application.vehiclePhvDiscNumber ?? "",
      vehicleEmissionStandard: application.vehicleEmissionStandard ?? "",
      vehicleIsUlezCompliant: application.vehicleIsUlezCompliant ?? false,
      documents: {
