    ...
    <SafeAreaView style={s.container}>
      <ScrollView>
          ...
          {driver && (
            <View style={s.ratingBadge}>
              <Text style={s.ratingText}>
                ★ {driver.rating?.toFixed(1)} · {driver.totalJobs} jobs
              </Text>
            </View>
          )}
        </View>
        ...
        >
          ...
          >
            Your PCO licence, vehicle documents, and insurance are monitored by
            your operator. You'll be notified when any document is approaching
            expiry.
          </Text>
        ...
        <TouchableOpacity
          style={s.themeCard}
          onPress={() => navigation.navigate("TeslaSettings")}
        >
          <View style={s.themeRow}>
            <Text style={s.themeIcon}>🚗</Text>
            <View style={{ flex: 1 }}>
              <Text style={s.themeLabel}>Tesla Integration</Text>
              <Text style={s.themeSub}>
                Auto-send routes to your Tesla screen
              </Text>
            </View>
            <Text style={{ color: Colors.brand, fontSize: FontSize.lg }}>
              →
